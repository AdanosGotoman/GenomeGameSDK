...
#define IM_VEC2_CLASS_EXTRA                                                                 \
        ImVec2(const Genome::Math::Vector2& f) { x = f.x; y = f.y; }                       \
        operator Genome::Math::Vector2() const { return Genome::Math::Vector2(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                                 \
        ImVec4(const Genome::Math::Vector4& f) { x = f.x; y = f.y; z = f.z; w = f.w; }     \
        operator Genome::Math::Vector4() const { return Genome::Math::Vector4(x,y,z,w); }
