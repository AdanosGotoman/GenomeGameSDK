...
namespace Window
{
    ...
    static std::function<void(Genome::WindowData& window_data)> g_on_message;
    ...
    {
        g_instance = instance;
        const std::wstring windowTitle    = Genome::FileSystem::StringToWstring(title);
